          ...
          <div id="modal-inner" onClick={(e) => e.stopPropagation()}>
            ...
            <Modal.Body>
              <div className="h-[60vh] space-y-6 overflow-y-auto p-6 pt-2 font-gesta">
                ...
                <p>The step-by-step instructions <a href="https://github.com/LEARNAcademy/Syllabus/blob/main/github/assessments.md">here</a> breakdown the git and GitHub process for this assessment.</p>
