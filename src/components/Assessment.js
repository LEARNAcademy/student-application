      ...
      {assess.map((assessment, index) => {        
        return (
          <div id="week" key={index} className="w-full border-b border-black py-10">
            <div id="dashboard-table" className="flex w-full flex-row justify-between">
              ...
              <div className="flex flex-col">
                <div className="flex w-full flex-row items-center">
                  <div id="name" className="my-1 mx-6 ml-16 text-lg"><strong>Status:</strong>
                    <span className={`mx-1 inline-block w-28 rounded-lg text-center ${statusColor[index]}`}>{assessment.status}</span>
                  </div>
                </div>
                <div id="name" className="my-1 mx-6 ml-16 text-lg"><strong>Reviewer:</strong> {assessment.reviewer} </div>
              </div>
            </div>
