  ...
  return (
    <>
      ...
      <div className="mx-auto mt-32 mb-16 h-auto w-[83vw] text-[#616161] sm:my-16">
        ...
        <p className="my-3">
          Unless otherwise stated, LEARN academy and/or it&apos;s licensors own the intellectual property rights for all material on LEARN academy. All intellectual property rights are reserved. You may view and/or print pages from <a className="text-learnpurple hover:text-learngreen active:text-learngreen" href="https://www.learnacademy.org" target="_blank" rel="noreferrer">LEARN academy&apos;s website</a> for your own personal use subject to restrictions set in these terms and conditions.
        </p>
        ...
        <p className="my-3">The following organizations may link to our Web site without prior written approval:</p>
