  ...
  return (
    <>
      ...
      <div className="mx-auto mt-32 mb-16 h-auto w-[83vw] text-[#616161] sm:my-16">
        ...
        <p className="my-3">LEARN academy is located at:</p>
        ...
        <p className="my-3 font-bold">You must not:</p>
        ...
        <ol className="ml-8 list-disc">
          <li className="my-3">Government agencies</li>
          <li className="my-3">Search engines</li>
          <li className="my-3">News organizations</li>
          <li className="my-3">
        ...
        <ol className="ml-8 list-disc">
          ...
          <li className="my-3">Dot.com community sites</li>
          <li className="my-3">
            Associations or other groups representing charities, including
            charity giving sites
          </li>
          <li className="my-3">Online directory distributors</li>
          <li className="my-3">Internet portals</li>
          <li className="my-3">
        ...
        <ol className="ml-8 list-disc">
          <li className="my-3">By use of our corporate name</li>
          <li className="my-3">
