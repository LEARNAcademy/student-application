  ...
  return (
    <>
      <div className="mx-auto mt-32 mb-16 h-auto w-[83vw] text-[#616161] sm:my-16">
        ...
        <p className="my-3 max-w-readable">
                Chelsea Kaufman: <a className="text-learnpurple hover:text-learngreen active:text-learngreen" href="mailto:Chelsea@learnacademy.org">Chelsea@learnacademy.org</a>
        </p>
        <p className="my-3 max-w-readable">
        ...
        <br></br>
        <h3 className="max-w-readable text-lg text-learnblack">
                Additional Resources:
        </h3>
        <ol className="ml-8 list-disc">
          <li className="my-3 max-w-readable"> <a className="text-learnpurple hover:text-learngreen active:text-learngreen" target="_blank" href="https://www.djangoproject.com/conduct/" rel="noreferrer">Code of Conduct - Django</a>
          </li>
